    ...
    <div class="row g-4">
        <div class="col-sm-12 col-md-8 d-flex align-items-center">
            ...
            <div class="text-start ps-4">
               <a href="/fulltime_listing/{{$fulltime_listing->id}}"><h5 class="mb-2">{{$fulltime_listing->company}}</h5></a> 
        ...
        <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
            <div class="d-flex mb-3">
                ...
                @endphp
                    @foreach ($tags as $tag)
                    <a class="btn me-1 tags" href="/fulltime_listing/{{$fulltime_listing->id}}">
                        {{ $tag }}
                    </a>
                   @endforeach
                <a class="btn btn-primary" href="/fulltime_listing/{{$fulltime_listing->id}}">Apply Now</a>
            </div>
